        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Import Supplier Management</h3> </div>
                                   ...
                                   <form class="form-horizontal" id="submitImportForm" action="php_action/createBrandImport.php" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                 <input type="file" class="form-control" id="brandfile" placeholder="Import Supplier File" name="brandfile" class="file-loading" style="width:auto;"/>
